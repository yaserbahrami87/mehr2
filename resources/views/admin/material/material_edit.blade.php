    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="/admin/material/{{$material->id}}" >
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                        ...
                        <div class="tab-pane fade show active" id="nav-farsi" role="tabpanel" aria-labelledby="nav-farsi-tab">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control"  id="material" name="material" value="{{old('material',$material->material)}}" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="1" @if($material->status==1) selected @endif>فعال</option>
                                        <option value="0" @if($material->status==0) selected @endif>غیرفعال</option>
                                    </select>
                                </div>
