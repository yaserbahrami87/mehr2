                            ...
                            <div class="tab-pane fade show active" id="nav-farsi" role="tabpanel" aria-labelledby="nav-farsi-tab">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control"   id="title_en" name="title_en" value="{{old('title_en',$news->title_en)}}" />
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" > توضیحات کوتاه انگلیسی:<span class="text-danger">*</span></span>
                                        </div>
                                        <textarea class="form-control" id="description_en" name="description_en">{{old('description_en',$news->description_en)}}</textarea>
                                    </div>
                                    <div class="input-group mb-3">
                                        <label for="content_en">متن خبر انگلیسی:<span class="text-danger">*</span></label>
                                        <textarea id="content_en" name="content_en">{{old('content_en',$news->content_en)}}</textarea>
                                    </div>
